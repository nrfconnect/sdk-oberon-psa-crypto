...
/*
 * Additional tests for PAKE, K1_256, ECDSA-P521, RSA OAEP.
...
static const uint8_t rsa_seed1[] = {
...
static const uint8_t rsa_enc1[] = {
     };
static const uint8_t rsa_msg2[] = {
...
static const uint8_t rsa_seed2[] = {
...
static const uint8_t rsa_enc2[] = {
     };
...
int test_rsa_oaep()
{
    ...
    psa_set_key_algorithm(&key_attr, PSA_ALG_RSA_OAEP(PSA_ALG_SHA_256));
    psa_set_key_type(&key_attr, PSA_KEY_TYPE_RSA_PUBLIC_KEY);
    TEST_ASSERT(psa_import_key(&key_attr, rsa_key, sizeof rsa_key, &key) == PSA_SUCCESS);

    oberon_test_drbg_setup(rsa_seed1, sizeof rsa_seed1);
    TEST_ASSERT(psa_asymmetric_encrypt(key, PSA_ALG_RSA_OAEP(PSA_ALG_SHA_256), rsa_msg1, sizeof rsa_msg1,
                                       rsa_label, sizeof rsa_label, ct, sizeof ct, &len) == PSA_SUCCESS);
    ASSERT_COMPARE(ct, len, rsa_enc1, sizeof rsa_enc1);

    oberon_test_drbg_setup(rsa_seed2, sizeof rsa_seed2);
    TEST_ASSERT(psa_asymmetric_encrypt(key, PSA_ALG_RSA_OAEP(PSA_ALG_SHA_256), rsa_msg2, sizeof rsa_msg2,
                                       rsa_label, sizeof rsa_label, ct, sizeof ct, &len) == PSA_SUCCESS);
    ASSERT_COMPARE(ct, len, rsa_enc2, sizeof rsa_enc2);

    // wrong seed
    oberon_test_drbg_setup(rsa_seed1, sizeof rsa_seed1);
    TEST_ASSERT(psa_asymmetric_encrypt(key, PSA_ALG_RSA_OAEP(PSA_ALG_SHA_256), rsa_msg2, sizeof rsa_msg2,
        rsa_label, sizeof rsa_label, ct, sizeof ct, &len) == PSA_SUCCESS);
    TEST_ASSERT(len == sizeof rsa_enc2);
    TEST_ASSERT(memcmp(ct, rsa_enc2, len) != 0);
