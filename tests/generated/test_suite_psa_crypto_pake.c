 ...
 *      Test suite file     : tests/suites/test_suite_psa_crypto_pake.function
 *      Test suite data     : tests/suites/test_suite_psa_crypto_pake.data
 *
 */
...
// defined in mbedtls for legacy handling
...
#line 2 "tests/suites/test_suite_psa_crypto_pake.function"
#include <stdint.h>
...
#if defined(PSA_WANT_ALG_JPAKE)
#line 591 "tests/suites/test_suite_psa_crypto_pake.function"
static void test_ecjpake_setup(int policy_alg_arg, int setup_alg_arg,
                   ...
                   int expected_error_arg)
{
    ...
    /* !!OM   algorithms not supported in Oberon-psa-crypto */
    if (PSA_PAKE_PRIMITIVE_GET_TYPE(primitive) == PSA_PAKE_PRIMITIVE_TYPE_DH) goto exit;
    if (PSA_PAKE_PRIMITIVE_GET_FAMILY(primitive) == PSA_ECC_FAMILY_SECP_K1) goto exit;
    if (PSA_PAKE_PRIMITIVE_GET_BITS(primitive) == 384) goto exit;
    if (PSA_ALG_GET_HASH(setup_alg) == PSA_ALG_SHA_1) goto exit;
    if (PSA_ALG_GET_HASH(setup_alg) == PSA_ALG_SHA3_256) goto exit;
    if (setup_alg == PSA_ALG_JPAKE_BETA) goto exit; // PSA_ALG_JPAKE_BETA
    if (policy_alg == PSA_ALG_JPAKE_BETA) goto exit; // PSA_ALG_JPAKE_BETA

    psa_pake_cs_set_algorithm(&cipher_suite, setup_alg);
    psa_pake_cs_set_primitive(&cipher_suite, primitive);
    
    /* !!OM  JPAKE enforces PSA_PAKE_UNCONFIRMED_KEY */ 
    if (PSA_ALG_IS_JPAKE(setup_alg)) psa_pake_cs_set_key_confirmation(&cipher_suite, PSA_PAKE_UNCONFIRMED_KEY);
    ...
    if (test_input) {
        ...
        output_key_share[0] = 0x04;  /* !!OM-PCI-25 */
...
#endif /* PSA_WANT_ALG_JPAKE */
#if defined(PSA_WANT_ALG_JPAKE)
#line 803 "tests/suites/test_suite_psa_crypto_pake.function"
...
static void test_ecjpake_rounds_inject_wrapper( void ** params )
{
    ...
    test_ecjpake_rounds_inject( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, &data3, ((mbedtls_test_argument_t *) params[5])->sint, ((mbedtls_test_argument_t *) params[6])->sint, ((mbedtls_test_argument_t *) params[7])->sint );
}
#endif /* PSA_WANT_ALG_JPAKE */
#if defined(PSA_WANT_ALG_JPAKE)
#line 860 "tests/suites/test_suite_psa_crypto_pake.function"
                    ...
                    int err_stage_arg)
{
    ...
    /* !!OM  output ket attributes must be valid */
    psa_set_key_usage_flags(&attributes, PSA_KEY_USAGE_DERIVE);
...
static void test_ecjpake_rounds_wrapper( void ** params )
{
    ...
    test_ecjpake_rounds( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, &data3, ((mbedtls_test_argument_t *) params[5])->sint, ((mbedtls_test_argument_t *) params[6])->sint, ((mbedtls_test_argument_t *) params[7])->sint );
}
#endif /* PSA_WANT_ALG_JPAKE */
#line 959 "tests/suites/test_suite_psa_crypto_pake.function"
...
#if defined(PSA_WANT_ALG_JPAKE)
#line 1003 "tests/suites/test_suite_psa_crypto_pake.function"
...
#endif /* PSA_WANT_ALG_JPAKE */
#if defined(PSA_WANT_ALG_JPAKE)
#line 1065 "tests/suites/test_suite_psa_crypto_pake.function"
...
#endif /* PSA_WANT_ALG_JPAKE */
#if defined(PSA_WANT_ALG_JPAKE)
#line 1108 "tests/suites/test_suite_psa_crypto_pake.function"
...
#endif /* PSA_WANT_ALG_JPAKE */
#if defined(PSA_WANT_ALG_JPAKE)
#line 1180 "tests/suites/test_suite_psa_crypto_pake.function"
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 12:
            {
                *out_value = ERR_IN_OUTPUT_KEY_SHARE;
            }
            break;
        case 13:
            {
        ...
        case 15:
            {
                *out_value = PSA_PAKE_PRIMITIVE(PSA_PAKE_PRIMITIVE_TYPE_ECC, PSA_ECC_FAMILY_SECP_R1, 384);
            }
            break;
        case 16:
            {
                *out_value = PSA_ALG_JPAKE(PSA_ALG_SHA_1);
            }
            break;
        case 17:
            {
                *out_value = PSA_ALG_JPAKE(PSA_ALG_SHA3_256);
            }
            break;
        case 18:
            {
        ...
        case 24:
            {
                *out_value = PSA_ALG_JPAKE(PSA_ALG_ANY_HASH);
            }
            break;
        case 25:
            {
                *out_value = PSA_ALG_JPAKE_BETA;
            }
            break;
        case 26:
            {
        ...
        case 33:
            {
                *out_value = ERR_INJECT_LARGE_BUFFER_SIZE;
            }
            break;
        case 34:
            {
                *out_value = ERR_INJECT_SMALL_BUFFER_SIZE;
            }
            break;
        case 35:
            {
