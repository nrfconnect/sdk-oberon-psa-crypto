...
#define ENTROPY_MIN_NV_SEED_SIZE                                        \
    MAX(MBEDTLS_ENTROPY_POLL_PLATFORM_MIN, MBEDTLS_ENTROPY_BLOCK_SIZE)
...
#if defined(MBEDTLS_ENTROPY_NV_SEED)
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 169 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 177 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 199 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#if defined(MBEDTLS_ENTROPY_NV_SEED)
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 244 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#endif /* MBEDTLS_ENTROPY_NV_SEED */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 273 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_reseed_basic(void)
{
    uint8_t random[10];
...
static void test_reseed_basic_wrapper( void ** params )
{
    (void)params;
...
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 303 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_prediction_resistance_bad_state(void)
{
    uint8_t random[10];
...
static void test_prediction_resistance_bad_state_wrapper( void ** params )
{
    (void)params;

    test_prediction_resistance_bad_state(  );
}
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 333 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_prediction_resistance_bad_arguments(void)
{
    uint8_t random[10];
...
static void test_prediction_resistance_bad_arguments_wrapper( void ** params )
{
    (void)params;

    test_prediction_resistance_bad_arguments(  );
}
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 357 "tests/suites/test_suite_psa_crypto_entropy.function"
...
static void test_reseed_consumption(void)
{
    uint8_t random[10] = { 0 };
...
static void test_reseed_consumption_wrapper( void ** params )
{
    (void)params;

    test_reseed_consumption(  );
}
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 402 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_deplete_consumption(void)
{
    uint8_t random[10] = { 0 };
...
static void test_deplete_consumption_wrapper( void ** params )
{
    (void)params;

    test_deplete_consumption(  );
}
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#if defined(MBEDTLS_ENTROPY_HAVE_TRUE_SOURCES)
#line 426 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_prediction_resistance_consumption(void)
{
    uint8_t random[10] = { 0 };
...
static void test_prediction_resistance_consumption_wrapper( void ** params )
{
    (void)params;

    test_prediction_resistance_consumption(  );
}
#endif /* MBEDTLS_ENTROPY_HAVE_TRUE_SOURCES */
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 466 "tests/suites/test_suite_psa_crypto_entropy.function"
static void test_reseed_uniqueness(data_t *perso1, data_t *perso2)
{
...
static void test_reseed_uniqueness_wrapper( void ** params )
{
    ...
    test_reseed_uniqueness( &data0, &data2 );
}
#endif /* !MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 533 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#endif /* MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 565 "tests/suites/test_suite_psa_crypto_entropy.function"
...
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#if defined(MBEDTLS_PLATFORM_IS_UNIXLIKE)
#line 616 "tests/suites/test_suite_psa_crypto_entropy.function"
...
static void test_psa_rng_fork(int parent_when)
{
    struct {
...
static void test_psa_rng_fork_wrapper( void ** params )
{

    test_psa_rng_fork( ((mbedtls_test_argument_t *) params[0])->sint );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 5:
            {
                *out_value = MBEDTLS_ENTROPY_POLL_PLATFORM_MIN - 1;
            }
            break;
        case 6:
            {
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_prediction_resistance_bad_state_wrapper,
#else
    NULL,
#endif
/* Function Id: 6 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_prediction_resistance_bad_arguments_wrapper,
#else
    NULL,
#endif
/* Function Id: 7 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_reseed_consumption_wrapper,
#else
    NULL,
#endif
/* Function Id: 8 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_deplete_consumption_wrapper,
#else
    NULL,
#endif
/* Function Id: 9 */

#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG) && defined(MBEDTLS_ENTROPY_HAVE_TRUE_SOURCES)
    test_prediction_resistance_consumption_wrapper,
#else
    NULL,
#endif
/* Function Id: 10 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_reseed_uniqueness_wrapper,
#else
    NULL,
#endif
/* Function Id: 11 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C) && !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG) && defined(MBEDTLS_PLATFORM_IS_UNIXLIKE)
    test_psa_rng_fork_wrapper,
#else
    NULL,
#endif
