 ...
 *
 * Test file      : ./test_suite_psa_crypto.concurrent.c
 *
 ...
 *      Test suite data     : tests/suites/test_suite_psa_crypto.concurrent.data
 *
 */
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_psa_crypto.concurrent.datax";
