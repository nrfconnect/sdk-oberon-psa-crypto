 ...
 *      Test suite file     : tests/suites/test_suite_psa_crypto_slot_management.function
 *      Test suite data     : tests/suites/test_suite_psa_crypto_slot_management.data
 *
 */
...
#line 2 "tests/suites/test_suite_psa_crypto_slot_management.function"
#include <stdint.h>
...
#line 115 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#line 197 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#if defined(MBEDTLS_PSA_CRYPTO_STORAGE_C)
#line 320 "tests/suites/test_suite_psa_crypto_slot_management.function"
static void test_create_existent(int lifetime_arg, int owner_id_arg, int id_arg,
                     int purge_policy_arg)
{
    psa_key_lifetime_t lifetime = lifetime_arg;
    mbedtls_svc_key_id_t id = mbedtls_svc_key_id_make(owner_id_arg, id_arg);
    mbedtls_svc_key_id_t returned_id = MBEDTLS_SVC_KEY_ID_INIT;
    ...
    purge_policy_t purge_policy = purge_policy_arg;
...
#endif /* MBEDTLS_PSA_CRYPTO_STORAGE_C */
#line 393 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#line 432 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#line 558 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#line 669 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#line 715 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#if defined(MBEDTLS_PSA_CRYPTO_STORAGE_C)
#line 828 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
#if defined(MBEDTLS_PSA_CRYPTO_STORAGE_C)
#if !defined(MBEDTLS_PSA_KEY_STORE_DYNAMIC)
#line 904 "tests/suites/test_suite_psa_crypto_slot_management.function"
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 14:
            {
                *out_value = PURGE_BEFORE;
            }
            break;
        case 15:
            {
                *out_value = PURGE_AFTER;
            }
            break;
        case 16:
            {
