...
int main(void)
{
    ...
    printf("Speed tests (cycles)                 Oberon PSA Crypto Drivers in Oberon PSA Crypto %i.%i.%i\r\n", 
                                                 OBERON_PSA_CRYPTO_VERSION_NUMBER >> 24,
                                                 (OBERON_PSA_CRYPTO_VERSION_NUMBER >> 16) & 0xFF,
                                                 (OBERON_PSA_CRYPTO_VERSION_NUMBER >> 8) & 0xFF);
