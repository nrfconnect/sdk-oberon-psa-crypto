...
#if defined(PSA_NEED_CC3XX_HASH_DRIVER) || defined(PSA_NEED_CC3XX_CIPHER_DRIVER)
...
typedef union {
    ...
    cc3xx_hash_operation_t cc3xx_hash_ctx;
#endif
#ifdef PSA_NEED_HARDWARE_DEMO_DRIVER
...
typedef union {
    ...
    cc3xx_cipher_operation_t cc3xx_cipher_ctx;
#endif
#ifdef PSA_NEED_HARDWARE_DEMO_DRIVER
