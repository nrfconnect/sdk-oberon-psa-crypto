...
|:------------------------------------- |:-------------------------------------------------------------------------------- |:-------------------------- |:------------- |
| SHA1                                  | PSA_WANT_ALG_SHA_1                                                               | -                          | 7)            |
| SHA2                                  | PSA_WANT_ALG_SHA_224/256/384/512                                                 | -                          | yes 8)        |
| SHA3                                  | PSA_WANT_ALG_SHA3_224/256/384/512                                                | -                          | yes 8)        |
| SHAKE                                 | PSA_WANT_ALG_SHAKE256-512                                                        | -                          | yes 8)        |
| HMAC                                  | PSA_WANT_ALG_HMAC                                                                | PSA_WANT_KEY_TYPE_HMAC     | yes 8)        |
| AES-CMAC                              | PSA_WANT_ALG_CMAC                                                                | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
| ChaCha20 (cipher)                     | PSA_WANT_ALG_STREAM_CIPHER                                                       | PSA_WANT_KEY_TYPE_CHACHA20 | yes           |
| AES (cipher)                          | PSA_WANT_ALG_CTR/CCM_STAR_NO_TAG/ECB_NO_PADDING/CBC_NO_PADDING/CCM/GCM/CBC_PKCS7 | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
| AES (key wrapping) 1)                 | PSA_WANT_ALG_KW/KWP                                                              | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
| AES (AEAD)                            | PSA_WANT_ALG_CCM/GCM                                                             | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
| ChaCha20-Poly1305 (AEAD)              | PSA_WANT_ALG_CHACHA20_POLY1305                                                   | PSA_WANT_KEY_TYPE_CHACHA20 | yes           |
| HKDF                                  | PSA_WANT_ALG_HKDF/HKDF_EXTRACT/HKDF_EXPAND                                       | PSA_WANT_KEY_TYPE_DERIVE   | yes 8)        |
| TLS-1.2 PRF                           | PSA_WANT_ALG_TLS12_PRF                                                           | PSA_WANT_KEY_TYPE_DERIVE   | yes 8)        |
| TLS-1.2 PSK-to-Mastersecret           | PSA_WANT_ALG_TLS12_PSK_TO_MS                                                     | PSA_WANT_KEY_TYPE_DERIVE   | yes 8)        |
| PBKDF2-HMAC                           | PSA_WANT_ALG_PBKDF2_HMAC                                                         | PSA_WANT_KEY_TYPE_HMAC     | yes 8)        |
| PBKDF2-AES-CMAC-PRF128                | PSA_WANT_ALG_PBKDF2_AES_CMAC_PRF_128                                             | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
| SP800-108-COUNTER-HMAC                | PSA_WANT_ALG_SP800_108_COUNTER_HMAC                                              | PSA_WANT_KEY_TYPE_HMAC     | yes 8)        |
| SP800-108-COUNTER-CMAC                | PSA_WANT_ALG_SP800_108_COUNTER_CMAC                                              | PSA_WANT_KEY_TYPE_AES      | yes 9)        |
...
| SPAKE2+                               | PSA_WANT_ALG_SPAKE2P_HMAC/CMAC/MATTER                                            | 5)                         | no            |
| SRP-6                                 | PSA_WANT_ALG_SRP_6                                                               | 6)                         | no            |
...
5) PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_BASIC/IMPORT/EXPORT/DERIVE.
6) PSA_WANT_KEY_TYPE_SRP_KEY_PAIR_BASIC/IMPORT/EXPORT/DERIVE.
7) Considered non-secure even without quantum computers. Use only for legacy compatibility.
8) Use of SHA384/SHA512/SHA3-384/SHA3-512/SHAKE256 recommended.
9) Use of AES-256 recommended.
