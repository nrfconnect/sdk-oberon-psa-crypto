    ...
    uint8_t *signature, size_t signature_size, size_t *signature_length)
{
    ...
    case 128:
        ...
        ocrypto_ml_dsa44_sign(&ctx.dsa44, signature, input, input_length, NULL, 0, sk, rnd);
    ...
    case 192:
        ...
        ocrypto_ml_dsa65_sign(&ctx.dsa65, signature, input, input_length, NULL, 0, sk, rnd);
    ...
    case 256:
        ...
        ocrypto_ml_dsa87_sign(&ctx.dsa87, signature, input, input_length, NULL, 0, sk, rnd);
    ...
    uint8_t *signature, size_t signature_size, size_t *signature_length)
{
    ...
    case 128:
        if (signature_size < ocrypto_ml_dsa44_SIG_SIZE) return PSA_ERROR_BUFFER_TOO_SMALL;
        ocrypto_ml_dsa44_key_pair(&ctx.dsa44, sk, signature, key);
        ocrypto_ml_dsa44_sign_hash(&ctx.dsa44, signature, hash, hash_length, oid, NULL, 0, sk, rnd);
        *signature_length = ocrypto_ml_dsa44_SIG_SIZE;
        return PSA_SUCCESS;
#endif /* PSA_NEED_OBERON_ML_DSA_44 */
#ifdef PSA_NEED_OBERON_ML_DSA_65
    case 192:
        if (signature_size < ocrypto_ml_dsa65_SIG_SIZE) return PSA_ERROR_BUFFER_TOO_SMALL;
        ocrypto_ml_dsa65_key_pair(&ctx.dsa65, sk, signature, key);
        ocrypto_ml_dsa65_sign_hash(&ctx.dsa65, signature, hash, hash_length, oid, NULL, 0, sk, rnd);
        *signature_length = ocrypto_ml_dsa65_SIG_SIZE;
        return PSA_SUCCESS;
#endif /* PSA_NEED_OBERON_ML_DSA_65 */
#ifdef PSA_NEED_OBERON_ML_DSA_87
    case 256:
        if (signature_size < ocrypto_ml_dsa87_SIG_SIZE) return PSA_ERROR_BUFFER_TOO_SMALL;
        ocrypto_ml_dsa87_key_pair(&ctx.dsa87, sk, signature, key);
        ocrypto_ml_dsa87_sign_hash(&ctx.dsa87, signature, hash, hash_length, oid, NULL, 0, sk, rnd);
        *signature_length = ocrypto_ml_dsa87_SIG_SIZE;
        return PSA_SUCCESS;
#endif /* PSA_NEED_OBERON_ML_DSA_87 */
    default:
    ...
    const uint8_t *signature, size_t signature_length)
{
    ...
    case 128:
        ...
        res = ocrypto_ml_dsa44_verify(&ctx->dsa44, signature, input, input_length, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_44 */
#ifdef PSA_NEED_OBERON_ML_DSA_65
    case 192:
        ...
        res = ocrypto_ml_dsa65_verify(&ctx->dsa65, signature, input, input_length, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_65 */
#ifdef PSA_NEED_OBERON_ML_DSA_87
    case 256:
        ...
        res = ocrypto_ml_dsa87_verify(&ctx->dsa87, signature, input, input_length, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_87 */
    default:
        (void)ctx;
    ...
    const uint8_t *signature, size_t signature_length)
{
    ...
    if (type == PSA_KEY_TYPE_ML_DSA_KEY_PAIR) {
        if (key_length != 32) return PSA_ERROR_INVALID_ARGUMENT;
        return oberon_ml_dsa_verify_message_sk(&ctx, key, bits, input, input_length, signature, signature_length);
    ...
    case 128:
        ...
        if (signature_length != ocrypto_ml_dsa44_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa44_verify(&ctx.dsa44, signature, input, input_length, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_44 */
#ifdef PSA_NEED_OBERON_ML_DSA_65
    case 192:
        ...
        if (signature_length != ocrypto_ml_dsa65_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa65_verify(&ctx.dsa65, signature, input, input_length, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_65 */
#ifdef PSA_NEED_OBERON_ML_DSA_87
    case 256:
        ...
        if (signature_length != ocrypto_ml_dsa87_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa87_verify(&ctx.dsa87, signature, input, input_length, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_87 */
    default:
        (void)input;
    ...
    const uint8_t *signature, size_t signature_length)
{
    ...
    case 128:
        if (signature_length != ocrypto_ml_dsa44_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        ocrypto_ml_dsa44_key_pair(&ctx->dsa44, NULL, pk, key);
        res = ocrypto_ml_dsa44_verify_hash(&ctx->dsa44, signature, hash, hash_length, oid, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_44 */
#ifdef PSA_NEED_OBERON_ML_DSA_65
    case 192:
        if (signature_length != ocrypto_ml_dsa65_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        ocrypto_ml_dsa65_key_pair(&ctx->dsa65, NULL, pk, key);
        res = ocrypto_ml_dsa65_verify_hash(&ctx->dsa65, signature, hash, hash_length, oid, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_65 */
#ifdef PSA_NEED_OBERON_ML_DSA_87
    case 256:
        if (signature_length != ocrypto_ml_dsa87_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        ocrypto_ml_dsa87_key_pair(&ctx->dsa87, NULL, pk, key);
        res = ocrypto_ml_dsa87_verify_hash(&ctx->dsa87, signature, hash, hash_length, oid, NULL, 0, pk);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_87 */
    default:
        (void)ctx;
    ...
    const uint8_t *signature, size_t signature_length)
{
    ...
    if (type == PSA_KEY_TYPE_ML_DSA_KEY_PAIR) {
        if (key_length != 32) return PSA_ERROR_INVALID_ARGUMENT;
        return oberon_ml_dsa_verify_hash_sk(&ctx, key, bits, oid, hash, hash_length, signature, signature_length);
    } else if (type != PSA_KEY_TYPE_ML_DSA_PUBLIC_KEY) {
        return PSA_ERROR_NOT_SUPPORTED;
    }
    ...
    case 128:
        if (key_length != ocrypto_ml_dsa44_PK_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        if (signature_length != ocrypto_ml_dsa44_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa44_verify_hash(&ctx.dsa44, signature, hash, hash_length, oid, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_44 */
#ifdef PSA_NEED_OBERON_ML_DSA_65
    case 192:
        if (key_length != ocrypto_ml_dsa65_PK_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        if (signature_length != ocrypto_ml_dsa65_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa65_verify_hash(&ctx.dsa65, signature, hash, hash_length, oid, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_65 */
#ifdef PSA_NEED_OBERON_ML_DSA_87
    case 256:
        if (key_length != ocrypto_ml_dsa87_PK_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        if (signature_length != ocrypto_ml_dsa87_SIG_SIZE) return PSA_ERROR_INVALID_ARGUMENT;
        res = ocrypto_ml_dsa87_verify_hash(&ctx.dsa87, signature, hash, hash_length, oid, NULL, 0, key);
        break;
#endif /* PSA_NEED_OBERON_ML_DSA_87 */
    default:
        (void)hash;
