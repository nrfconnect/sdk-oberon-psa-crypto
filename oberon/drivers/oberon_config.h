...
#if (defined(PSA_WANT_ALG_SHA_1) && !defined(PSA_ACCEL_SPAKE2P_SECP_R1_256_SHA_1)) || \
    (defined(PSA_WANT_ALG_SHA_224) && !defined(PSA_ACCEL_SPAKE2P_SECP_R1_256_SHA_224)) || \
    (defined(PSA_WANT_ALG_SHA_256) && !defined(PSA_ACCEL_SPAKE2P_SECP_R1_256_SHA_256)) || \
    (defined(PSA_WANT_ALG_SHA_384) && !defined(PSA_ACCEL_SPAKE2P_SECP_R1_256_SHA_384)) || \
    (defined(PSA_WANT_ALG_SHA_512) && !defined(PSA_ACCEL_SPAKE2P_SECP_R1_256_SHA_512))
#define PSA_NEED_OBERON_PAKE_DRIVER 1
#define PSA_NEED_OBERON_SPAKE2P 1
#define PSA_NEED_OBERON_SPAKE2P_SECP_R1_256 1
#endif
#endif
