...
_Static_assert(PSA_EXPORT_PUBLIC_KEY_MAX_SIZE <= PSA_CRYPTO_MAX_STORAGE_SIZE,
...
_Static_assert(PSA_EXPORT_KEY_PAIR_MAX_SIZE <= PSA_CRYPTO_MAX_STORAGE_SIZE,
    "The enabled asymmetric key pair size cannot fit in the PSA key store buffer," \
    "increase the config MBEDTLS_PSA_STATIC_KEY_SLOT_BUFFER_SIZE.");
_Static_assert(PSA_CIPHER_MAX_KEY_LENGTH <= PSA_CRYPTO_MAX_STORAGE_SIZE,
