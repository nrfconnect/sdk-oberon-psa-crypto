...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OBERON_DEMO_DRIVER_LOCATION:
        return demo_opaque_destroy_key(
            attributes, key_buffer, key_buffer_size);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OBERON_DEMO_DRIVER_LOCATION:
        status = demo_opaque_key_derivation_setup(
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        return demo_opaque_key_derivation_set_capacity(
            &operation->ctx.opaque_kdf_ctx,
            capacity);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        return demo_opaque_key_derivation_input_bytes(
            &operation->ctx.opaque_kdf_ctx,
            step,
            data, data_length);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
    ...
    case OPAQUE_DEMO_DRIVER_ID:
        ...
        case PSA_KEY_LOCATION_LOCAL_STORAGE:
            return demo_opaque_key_derivation_input_bytes(
                ...
                key, key_length);
        case OBERON_DEMO_DRIVER_LOCATION:
            return demo_opaque_key_derivation_input_key(
                &operation->ctx.opaque_kdf_ctx,
                step,
                attributes,
                key, key_length);
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        return demo_opaque_key_derivation_input_integer(
            &operation->ctx.opaque_kdf_ctx,
            step,
            value);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        return demo_opaque_key_derivation_output_bytes(
            &operation->ctx.opaque_kdf_ctx,
            output, output_length);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        if (PSA_KEY_LIFETIME_GET_LOCATION(key_attributes->lifetime) != OBERON_DEMO_DRIVER_LOCATION) {
            return PSA_ERROR_NOT_SUPPORTED;
        }
        return demo_opaque_key_derivation_output_key(
            &operation->ctx.opaque_kdf_ctx,
            key_attributes,
    ...
    const uint8_t *key, size_t key_length)
{
    ...
    case OPAQUE_DEMO_DRIVER_ID:
        ...
        return demo_opaque_key_derivation_verify_key(
            &operation->ctx.opaque_kdf_ctx,
            key_attributes,
            key, key_length);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OPAQUE_DEMO_DRIVER_ID:
        return demo_opaque_key_derivation_abort(&operation->ctx.opaque_kdf_ctx);
#endif /* PSA_NEED_OPAQUE_DEMO_DRIVER */
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OBERON_DEMO_DRIVER_LOCATION:
        return demo_opaque_key_agreement(
            attributes, key, key_length,
            alg,
            peer_key, peer_key_length,
            output, output_size, output_length);
...
#ifdef PSA_NEED_OPAQUE_DEMO_DRIVER
    case OBERON_DEMO_DRIVER_LOCATION:
        if (PSA_KEY_LIFETIME_GET_LOCATION(output_attributes->lifetime) != OBERON_DEMO_DRIVER_LOCATION) {
            return PSA_ERROR_NOT_SUPPORTED;
        }
        return demo_opaque_key_agreement_to_key(
            attributes, key, key_length,
            alg,
            peer_key, peer_key_length,
            output_attributes,
    ...
    uint8_t *data, size_t data_size, size_t *data_length)
{
    ...
    case PSA_KEY_LOCATION_LOCAL_STORAGE:
        /* Add cases for transparent drivers here */
#ifdef PSA_NEED_OBERON_KEY_WRAP_DRIVER
        if (PSA_KEY_LIFETIME_GET_LOCATION(key_attributes->lifetime) != PSA_KEY_LOCATION_LOCAL_STORAGE) {
            return PSA_ERROR_NOT_SUPPORTED;
        }
