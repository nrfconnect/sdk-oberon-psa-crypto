...
- Unnecessary code within the _dispatch logic_ is filtered out.
...
- `targets/acme/demo/dispatch/psa/crypto_config.h`
...
- `targets/acme/demo/drivers/demo_driver_config.h`.
