...
drivers have to conform to the _PSA Crypto Driver Interface__. A driver
implementation consists of a C header file and an implementation file that must
adhere to the naming conventions specified by _PSA Crypto_.

Ideally, a template for how to integrate this driver into the _dispatch logic_
...
see the _PSA Crypto Driver Interface_ documentation on GitHub.
...
[targets/acme/demo/drivers/demo_driver_config.h](../platforms/demo/drivers/demo_driver_config.h)
...
- `drivers/oberon/oberon_driver_config.h`
...
`targets/acme/demo/drivers/demo_entropy.c`. It is not intended for
production purposes.
...
to the otherwise private _dispatch logic_ interface.
