...
/*
 * OBERON_PSA_CRYPTO_DRIVER_KEY_DERIVATION_VERSION_NUMBER 1.6.0
 */
...
static const uint8_t zero[PSA_HASH_MAX_SIZE] = { 0 };
    ...
    defined(PSA_NEED_OBERON_PBKDF2_AES_CMAC_PRF_128) || defined(PSA_NEED_OBERON_SP800_108_COUNTER_HMAC) || \
    defined(PSA_NEED_OBERON_SP800_108_COUNTER_CMAC) || defined(PSA_NEED_OBERON_TLS12_PRF) || \
    defined(PSA_NEED_OBERON_TLS12_PSK_TO_MS) || defined(PSA_NEED_OBERON_WPA3_SAE_H2E)
...
#if defined(PSA_NEED_OBERON_HKDF) || defined(PSA_NEED_OBERON_HKDF_EXTRACT) || defined(PSA_NEED_OBERON_WPA3_SAE_H2E)
